...
# Buttons
tk.Button(window, text="Submit", command=save_to_excel, width=20, bg="#FF007F", fg="white").grid(row=3, column=0, columnspan=2, pady=10)
tk.Button(window, text="View Stored Data", command=show_data, width=20, bg="#FF6EC7", fg="white").grid(row=4, column=0, columnspan=2)
